...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    setSearchResults(combinedResults as (Game | Artist | Song)[]);
  }, [searchQuery]);
  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center h-10 md:h-12 px-4 md:px-6">
        ...
        >
          <span className={cn("font-bold text-2xl",isDark ? "text-white" : "text-gray-900")}>
            {WEBSITE_NAME}
          </span>
        </Link>
                  ...
                  <NavigationMenuItem key={url}>
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? isDark ? "text-gray-100 bg-primary/20" : "text-primary bg-primary/10"
                          : isDark ? "text-gray-200 hover:text-gray-100 hover:bg-primary/10" : "text-gray-800 hover:text-primary hover:bg-primary/10"
                      )}
            ...
            <Sheet>
              ...
              <SheetContent
                ...
                className={cn(
                  ...
                  isDark ? "bg-slate-900/95 border-slate-700" : "bg-background/95 border-slate-200"
                )}
              >
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            isActive
                              ? isDark ? "bg-primary/20 text-gray-100 font-medium" : "bg-primary/10 text-primary font-medium"
          ...
          <div className="container mx-auto px-4 py-3">
            <div className="relative w-full flex items-center">
              ...
              <input
                ...
                className={cn(
                  "w-full pl-10 pr-16 py-2 rounded-md border",
                  isDark 
              ...
              />
              {searchQuery && (
                <Button variant="ghost" size="icon" onClick={clearSearchInput} className="absolute right-[44px] h-8 w-8">
                  <XIcon className={cn("h-4 w-4", isDark ? "text-gray-400 hover:text-gray-200" : "text-gray-500 hover:text-gray-800")} />
                </Button>
              )}
               <Button variant="ghost" size="icon" onClick={closeSearchUI} className="absolute right-1 h-8 w-8">
                  <XIcon className={cn("h-5 w-5", isDark ? "text-gray-400 hover:text-gray-200" : "text-gray-500 hover:text-gray-800")} />
                </Button>
            </div>
            {searchQuery && searchResults.length > 0 && (
              ...
              >
                {searchResults.map((item, index) => {
                  ...
                  return (
                    <Link href={href} key={`${type}-${(item as any).id || index}`} onClick={closeSearchUI}>
                      <div className={cn(
